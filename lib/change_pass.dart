...
class _CpassState extends State<Cpass> {
  ...
  Future<void> logoutapi() async {
    ...
    try{
      ...
      var rsp = await apiurl("/process", "logout.php", {
        "_req_token": token
      });
  ...
  void CpassApi () async{
    ...
    try{
      ...
      if(rsp.containsKey('status')){
        ...
        if(rsp['status'].toString()=="true"){
          setState(() {
            showPrintedMessage(context, "Success", "Passowrd reset successfully", Colors.white,Colors.green, Icons.info, true, "top");
          });
          logoutapi();
        ...
        if(rsp['error'].toString()=="invalid_auth"){
          showPrintedMessage(context, "Error", "Old password is not correct", Colors.white,Colors.redAccent, Icons.info, true, "bottom");
        }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: showloader==false?ElevatedButton(
                                      style: ButtonStyle(
                                      ...
                                      onPressed: () {
                                        if(oldpassController.text.isEmpty||confpassController.text.isEmpty||fnewpassController.text.isEmpty){
                                          showPrintedMessage(context, "Alert", "Please fill all reured fields", Colors.white,Colors.red, Icons.info, true, "top");
                                        }else{
                                          if(fnewpassController.text==confpassController.text) {
                                            CpassApi();
                                          }else{
                                            showPrintedMessage(context, "Alert", "New Password and confirm password are not same", Colors.white,Colors.red, Icons.info, true, "top");
                                          }
                                        }
                                      },
                                      child: Text(
