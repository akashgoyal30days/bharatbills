...
class AddCustomer extends StatefulWidget {
  AddCustomer({required this.fromscreen});
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            toolbarHeight: 40,
            elevation: 0,
            title: Text('Add ${widget.fromscreen}', style: GoogleFonts.poppins(fontSize: 16),),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (v){
                                        if(v.isNotEmpty){
                                          setState(() {
                                            fwgstnoController.text = fwgstnoController.text.toString().toUpperCase();
                                            fwgstnoController.selection = TextSelection.fromPosition(TextPosition(offset: fwgstnoController.text.length));
                                          });
                                        }else{
                                          setState(() {
                                            fwgstnoController.clear();
