...
class AddReciept extends StatefulWidget {
  @override
  _AddRecieptState createState() => _AddRecieptState();
}
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            toolbarHeight: 40,
            elevation: 0,
            title: Text('Add Receipt', style: GoogleFonts.poppins(fontSize: 16),),
                      ...
                      child:  Container(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: new InputDecoration(
                              isDense: true,labelText: "Receipt Amount *",
                              labelStyle: GoogleFonts.poppins(
                                  fontSize: 14, color: AppBarColor
                              ),
                              fillColor: Colors.white.withOpacity(0.5),
