      ...
      for(var i=0; i<products.length; i++){
        if(products[i]['value']!='0.0') {
          ...
          if(selected_cloud_provide_rper.contains('-')){
            rateval.add((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100))*double.parse(products[i]['value'].toString()));
          }
          else{
            rateval.add((double.parse(products[i]['rate'].toString())+(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100))*double.parse(products[i]['value'].toString()));
          }
    ...
    setState((){
      ...
      for(var i=0; i<products.length; i++){
        ...
        if(products[i]['value']!='0.0') {
          ...
          if(selected_cloud_provide_rper.contains('-')){
            total_base_rate.add((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
            intrim_prod_base_rate.add((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
            prod_rate_with_discount.add((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
          }
          else{
            total_base_rate.add((double.parse(products[i]['rate'].toString())+(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
            intrim_prod_base_rate.add((double.parse(products[i]['rate'].toString())+(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
        ...
        */  // intrim_prod_base_rate.add((double.parse(products[i]['rate'].toString())*double.parse(products[i]['value'].toString())).toStringAsFixed(2));
          ...
          if(gst_type!='inclu') {
            if(selected_cloud_provide_rper.contains('-')){
              totalselected_rate.add((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
            }
            else{
              totalselected_rate.add((double.parse(products[i]['rate'].toString())+(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100)));
            }
            ...
            if(selected_cloud_provide_rper.contains('-')){
              totalselected_rate.add(((double.parse(products[i]['rate'].toString())-(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100))/(1+(double.parse(products[i]['gst'].toString())/100))).toStringAsFixed(2));
            }else{
              totalselected_rate.add(((double.parse(products[i]['rate'].toString())+(double.parse(products[i]['rate'].toString())*(double.parse(selected_cloud_provide_rper.toString().replaceAll('-', '')))/100))/(1+(double.parse(products[i]['gst'].toString())/100))).toStringAsFixed(2));
            }
          }
    ...
    return showbill_loader==false?WillPopScope(
        ...
        child: isadditem_clicked==false?Scaffold(
            ...
            appBar: AppBar(
              ...
              title:Text('Add Sale Bill', style: GoogleFonts.poppins(fontSize: 16),),
            ),
            ...
            body: totalselected_id.isNotEmpty?Container(
              ...
              child: showpartyfields==true?ListView.builder(
                  shrinkWrap: true,
                                        ...
                                        children: [
                                          if(additional_charges.isEmpty)
                                            Container(
                                              ...
                                              child: TextButton(
                                                  onPressed:null,
                                                  child: Text('Additional Charges', style:TextStyle(
                ...
                child:Padding(
                  ...
                  child: showcreateitemloader==false?Container(
                      ...
                      child: RaisedButton(
                          ...
                          splashColor: Colors.transparent,
                          onPressed:(){
                            if(add_item_name_Controller.text.isNotEmpty&&uom1 != null&&newitemgstper!=null&&catname!=null){
                              addItem();
                            }else{
