      ...
      if (rsp.containsKey('status')) {
        ...
        if (rsp['status'].toString() == "true") {
          ...
          Navigator.pushReplacement(
              context,
              PageTransition(
                  type: PageTransitionType.fade, child: StockTransferScreen()));
        } else if (rsp['status'].toString() == "false") {
          setState(() {
            showloader = false;
              ...
              if (rsp['data'][i]['pr_type'].toString() == 'Stockable') {
                if (isnegative_stock_allowed == true) {
                  ...
                  if (rsp['data'][i]['cur_bal'].toString() != 'N/A') {
                    if (double.parse(rsp['data'][i]['cur_bal'].toString()) <=
                        0) {
                    } else {
                      pro_name1.add(rsp['data'][i]['name'].toString());
                      prod_stock.add(rsp['data'][i]['cur_bal'].toString());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
            ...
            children: [
              Column(
                children: [
                  ...
                  Container(
                      height: selected_prod_id.isEmpty
                          ...
                          : Container(
                              child: Column(
                                children: [
                                                  ...
                                                  onChanged: (s) {
                                                    ...
                                                    setState(() {
                                                      ...
                                                      selectedprodidd =
                                                          prod_id2[index]
                                                              .toString();
                                                      selecteduom1 = uom1[index]
                                                          .toString();
                                                      selecteduom2 = uom2[index]
                                                          .toString();
                                                      currstock = Colors.grey
                                                          .withOpacity(0.3);
                                                      curstocktextcolor =
                                                          Colors.black;
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    setState(() {
                                                      if (selectedprodidd !=
                                                          ...
                                                          selected_ware2 !=
                                                              null) {
                                                        selected_pro_name.add(
                                                            selectedprodname
                                                                .toString());
                                                        selected_index.add(
                                                            inddex.toString());
                                                        selected_prod_id.add(
                                                            selectedprodidd
                                                                .toString());
                                                        selected_prod_quant1.add(
                                                            quant1Controller
                                                                .text
                                                                .toString());
                                                        if (quant2Controller
                                                            .text.isNotEmpty) {
                                                          selected_prod_quant2.add(
                                                              quant2Controller
                                                                  .text
                                                                  .toString());
                                                        } else {
                                                        ...
                                                        showPrintedMessage(
                                                            context,
                                                            "Error",
                                                            "Please fill the required fields to add product",
                                                            Colors.white,
                                                            Colors.redAccent,
                                                            Icons.info,
                                                            true,
                                  ...
                                  Expanded(
                                    child: selected_prod_id.isNotEmpty
                                        ? ListView.builder(
                                            itemCount: selected_prod_id.length,
                                            itemBuilder:
                                                (BuildContext context, indexz) {
                                              return Padding(
                                                padding: const EdgeInsets.only(
                                                    left: 10,
                                                    right: 10,
                                                                ...
                                                                child:
                                                                    RaisedButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            pro_name2.insert(int.parse(selected_index[indexz].toString()),
                                                                                selected_pro_name[indexz].toString());
                                                                            prod_id2.insert(int.parse(selected_index[indexz].toString()),
                                                                                selected_prod_id[indexz].toString());
                                                                            uom1.insert(int.parse(selected_index[indexz].toString()),
                                                                                selected_pro_name[indexz].toString());
                                                                            uom2.insert(int.parse(selected_index[indexz].toString()),
                                                                                selected_prod_id[indexz].toString());
                                                                          });
                                                                          ...
                                                                          selected_prod_stock
                                                                              .removeAt(indexz);
                                                                          selected_prod_quant1
                                                                              .removeAt(indexz);
                                                                          selected_prod_quant2
                                                                              .removeAt(indexz);
                                                                        },
                                                                        child: Center(
                                                                            child:
                                        ...
                                        : Center(
                                            child: Text(
                                            'Please fill above fields to transfer stock',
                                            style: TextStyle(
                                                fontSize: 16,
                                                color: Colors.blue,
                                                fontWeight: FontWeight.w500),
        ...
        bottomNavigationBar: selected_prod_id.isEmpty
            ? Container(height: 0)
            : Container(
                height: 100,
                width: MediaQuery.of(context).size.width,
