        ...
        if (rsp['status'].toString() == "true") {
          ...
          setState(() {
            ...
            Navigator.pushReplacement(
                context,
                PageTransition(
                    type: PageTransitionType.fade, child: PaymentScreen()));
          });
        } else if (rsp['status'].toString() == "false") {
          setState(() {
            showloader = false;
          ...
          showPrintedMessage(context, "Failed", "Category already exist",
              Colors.white, Colors.redAccent, Icons.info, true, "bottom");
        }
      } else {
                                ...
                                child: ElevatedButton(
                                  style: ButtonStyle(
                                    ...
                                    shadowColor: MaterialStateProperty.all(
                                        Colors
                                            .transparent), //Defines shadowColor
                                  ),
                                  onPressed: () {
                                    setState(() {});
                                    _selectDate(context);
                              ...
                              onPressed: () {
                                if (selectedcomp == '' ||
                                  ...
                                  showPrintedMessage(
                                      context,
                                      "Alert",
                                      "Please fill category name fields to submit",
                                      Colors.white,
                                      Colors.redAccent,
                                      Icons.info,
                                      true,
