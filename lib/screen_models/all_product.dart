...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: products.isNotEmpty ? scaffoldbackground : Colors
            .white,
            ...
            children: [
              Column(
                children: [
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      selecteddescription=products[index]['item_desc']
                                          .toString();
                                      selectedgstper=products[index]['gst']
                                          .toString();
                                      selectedconversionval=products[index]['conversion']
                                          .toString();
                                      slectedbullet= products[index]['rate_on']
                                          .toString();
                                      selectedminlevel= "";
                                      selectedmaxlevel="";
                                      selectedreorderlevel="";
                                      selectedopenquant=products[index]['open_quant']
                                          .toString();
                                      selectedopenamnt=products[index]['open_amt']
                                          .toString();

                                      selectedcustid = products[index]['iid']
                                          .toString();
                                      ...
                                      uom2 = products[index]['uom2']
                                          .toString();
                                      selecte_cat_did = products[index]['cat_id']
                                          .toString();
                                      selectedparid = products[index]['par_id']
                                          .toString();
                                      selectedname = products[index]['name']
                                          .toString();
                                      if(products[index]['is_active'].toString()=="1") {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      selectedcustid = items[index]['iid']
                                          .toString();
                                      srate = items[index]['rate']
                                          .toString();
                                      ...
                                      pdct = items[index]['pr_type']
                                          .toString();
                                      uom1 = items[index]['uom1']
                                          .toString();
                                      uom2 = items[index]['uom2']
                                          .toString();
                                      selecte_cat_did = items[index]['cat_id']
                                          .toString();
                                      selectedparid = items[index]['par_id']
                                          .toString();
                                      selectedname = items[index]['name']
                                          .toString();
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == false)
                    Expanded(
                      child: Container(
                        height: showalert==false&&products.isNotEmpty?MediaQuery.of(context).size.height-200:showalert==false&&products.isEmpty?MediaQuery.of(context).size.height-200:310,
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text('Product Details', style: GoogleFonts.poppins(fontSize: 15, color: Colors.white),),
                                  GestureDetector(
                                      onTap: (){
                                        setState(() {
                                          showalert=false;
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text('UOM 1 :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width/5.5,
                                        child: Text(" "+uom1, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                                Row(

                                  children: [
                                    Text('UOM 2 :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width/5.5,
                                        child: Text(" "+uom2, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text('Sales Rate :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width/5.5,
                                        child: Text(" "+srate, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                                Row(

                                  children: [
                                    Text('Purchase Rate :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width/5.5,
                                        child: Text(" "+prate, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Row(
                                  children: [
                                    Text('Hsn code :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width-150,
                                        child: Text(" "+hsn, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Row(
                                  children: [
                                    Text('Product :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width-150,
                                        child: Text(" "+pdct, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          Row(
                            ...
                            children: [
                              RaisedButton(
                                ...
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10)),
                                child: Text('Edit Products',style: GoogleFonts.poppins(fontSize: 16, color: Colors.white),),
                                onPressed: (){
                                  Navigator.of(context)
                                      .popUntil((route) =>
                                  route.isFirst);
                              ...
                              RaisedButton(
                                ...
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10)),
                                child: Text('Delete Product',style: GoogleFonts.poppins(fontSize: 16, color: Colors.white),),
                                onPressed: (){
              ...
              if(showalert == false)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "products",),
                ),
              if(showalert==false)
                Positioned(
                  top: 100,
