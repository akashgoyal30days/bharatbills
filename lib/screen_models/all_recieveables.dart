    ...
    try{
      ...
      if(rsp.containsKey('status')){
        ...
        if(rsp['status'].toString()=="true"){
          setState(() {
            if(contact!='') {
              FlutterOpenWhatsapp.sendSingleMessage('+91'+contact, rsp['message'].toString());
            }else{
              showPrintedMessage(context, "Alert", "Not a valid number", Colors.white,Colors.redAccent, Icons.info, true, "bottom");
            }
          });
            ...
            children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Receivables', style: GoogleFonts.poppins(
                                ...
                                return GestureDetector(
                                  onTap: (){
                                    ...
                                    setState(() {
                                      ...
                                      selectedamount = "";
                                      selectedcontact = "";
                                      selectedcontact = allcustomers[index]['phone'].toString();
                                      selectedcustid = allcustomers[index]['cid'].toString();
                                      selectedamount = allcustomers[index]['cur_bal'].toString();
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          GestureDetector(
                                                              onTap:(){
                                                                if(allcustomers[index]['phone'].toString()!="") {
                                                                  getpayrem_msg(allcustomers[index]['cid'].toString(),allcustomers[index]['cur_bal'].toString(),allcustomers[index]['phone'].toString());
                                                                }else{
                                                                  showPrintedMessage(context, "Error", "Invalid phone number", Colors.white,Colors.redAccent, Icons.info, true, "bottom");
                                                                }
                                                              },
                                ...
                                return GestureDetector(
                                  onTap: (){
                                    ...
                                    setState(() {
                                      ...
                                      selectedamount = "";
                                      selectedcontact = "";
                                      selectedcontact = items[index]['phone'].toString();
                                      selectedcustid = items[index]['cid'].toString();
                                      selectedamount = items[index]['cur_bal'].toString();
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          GestureDetector(
                                                              onTap:(){
                                                                if(items[index]['phone'].toString()!="") {
                                                                  getpayrem_msg(items[index]['cid'].toString(),items[index]['cur_bal'].toString(),items[index]['phone'].toString());
                                                                }else{
                                                                  showPrintedMessage(context, "Error", "Invalid phone number", Colors.white,Colors.redAccent, Icons.info, true, "bottom");
                                                                }
                                                              },
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Customer Details', style: GoogleFonts.poppins(fontSize: 15, color: Colors.white),),
                                  GestureDetector(
                                      onTap: (){
                                        setState(() {
                                          showalertdetail=false;
              ...
              if(showalertdetail==false)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "allrecievalbes",),
                ),
            ],
          ),
