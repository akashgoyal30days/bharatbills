  ...
  void activateBillFormat(String id) async {
    ...
    try {
      ...
      if (rsp.containsKey('status')) {
        ...
        if (rsp['status'].toString() == "true") {
          setState(() {
            showPrintedMessage(context, "Success", "Activated", Colors.white,
                Colors.green, Icons.info, true, "top");
          });
        } else if (rsp['status'].toString() == "false") {
          setState(() {
            showloader = false;
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(allformat[index]
                                                    ['file']
                                                .toString()),
                                            fit: BoxFit.fill,
                                          ),
                                    ...
                                    RaisedButton(
                                      ...
                                      color: Colors.green,
                                      onPressed: () {
                                        activateBillFormat(allformat[index]
                                                ['format']
                                            .toString());
                                      },
                                      child: Text(
