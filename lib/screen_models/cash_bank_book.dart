  ...
  void filterSearchResults(String query) {
    ...
    if(query.isNotEmpty) {
      ...
      dummySearchList.forEach((item) {
        if(item['acc_num'].toString().toLowerCase().contains(query.toLowerCase())||item['acc_name'].toString().toLowerCase().contains(query.toLowerCase())) {
          setState(() {
      ...
      setState(() {
        ...
        for(var i=0; i<items.length; i++){
          ...
          element['acc_num'] == items[i]['acc_num']);
            ...
            children: [
              Column(
                children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Cash/Bank Book', style: GoogleFonts.poppins(
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == true)
                    Container(
                      height: showalertdetail==false&&purchase.isNotEmpty?MediaQuery.of(context).size.height-200:showalertdetail==false&&purchase.isEmpty?MediaQuery.of(context).size.height-200:310,
                      width: MediaQuery.of(context).size.width,
                      color: Colors.white,
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Text(purchase[index]['acc_name'].toString(), style: GoogleFonts.poppins(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+purchase[index]['acc_type'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(left:12, top:0,bottom: 2, right: 8),
                                        child: Align(
                                          alignment: Alignment.centerLeft,
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(" "+"₹"+" "+purchase[index]['cur_bal'].toString(), style: GoogleFonts.poppins(
                                                      fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                  ),),
                                                ],
                                              ),
                                        ...
                                        child: Align(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Text('Account no :', style: GoogleFonts.poppins(
                                                      fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                  ),),
                                                  Text(" "+purchase[index]['acc_num'].toString(), style: GoogleFonts.poppins(
                                                      fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                  ),),
                                                ],
                                              ),
                                        ...
                                        child: Column(
                                          children: [
                                            Padding(
                                              ...
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(items[index]['acc_name'].toString(), style: GoogleFonts.poppins(
                                                    fontSize: 16, color: Colors.black, fontWeight: FontWeight.w500
                                                ),),
                                              ),
                                            ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['acc_type'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(" "+items[index]['acc_num'].toString(), style: GoogleFonts.poppins(
                                                      fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                  ),),
                                                ],
                                              ),
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == false)
                    Container(
                      ...
                      color: Colors.white,
                      child: Center(
                        child: Text('No bank found', style: GoogleFonts.poppins(
                            fontSize: 18, color: Colors.black
                        ),),
                      ),
                    ),
                                        ...
                                        child: Column(
                                          children: [
                                            Padding(
                                              ...
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(items[index]['Type'].toString(), style: GoogleFonts.poppins(
                                                    fontSize: 16, color: Colors.black, fontWeight: FontWeight.w500
                                                ),),
                                              ),
                                            ),
              ...
              if(showalertdetail==false)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "cashbankbook",),
                ),
              if(showalertdetail==false)
              Positioned(
                top: 100,
