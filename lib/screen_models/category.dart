...
class _CategoryScreenState extends State<CategoryScreen> {
      ...
      if(rsp.containsKey('status')){
        ...
        showloader=false;
          ...
          if(rsp['error'].toString()=="data exists"){
            showPrintedMessage(context, "Error", "This customer has data", Colors.white,Colors.redAccent, Icons.info, true, "bottom");
          }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: purchase.isNotEmpty ? scaffoldbackground : Colors
            .white,
            ...
            children: [
              Column(
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      selectedparid="";
                                      selectedname = "";
                                      selecteddescription = purchase[index]['cat_desc']
                                          .toString();
                                      selectedid = purchase[index]['cat_id']
                                          .toString();
                                      selectedparid = purchase[index]['par_id']
                                          .toString();
                                      selectedname = purchase[index]['name']
                                          .toString();
                                    });
                                  },
                                  child: Container(
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      selectedparid="";
                                      selectedname = "";
                                      selecteddescription = items[index]['cat_desc']
                                          .toString();
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == false)
                    Expanded(
                      child: Container(
                        ...
                        color: Colors.white,
                        child: Center(
                          child: Text('No category found', style: GoogleFonts.poppins(
                              fontSize: 18, color: Colors.black
                          ),),
                        ),
                      ),
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text('Category Details', style: GoogleFonts.poppins(fontSize: 15, color: Colors.white),),
                                  GestureDetector(
                                      onTap: (){
                                        setState(() {
                                          showalert=false;
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Row(
                                  children: [
                                    Text('Description :', style: GoogleFonts.poppins(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),),
                                    Container(
                                        width: MediaQuery.of(context).size.width-150,
                                        child: Text(" "+selecteddescription, style: GoogleFonts.poppins(fontSize: 15, color: Colors.black),)),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          SizedBox(height: 10,),
                              Row(
                                ...
                                children: [
                                  RaisedButton(
                                    ...
                                    child: Text('Edit Category',style: GoogleFonts.poppins(fontSize: 16, color: Colors.white),),
                                    onPressed: (){
                                      Navigator.of(context)
                                          .popUntil((route) =>
                                      route.isFirst);
                                      Navigator
                                          ...
                                          PageTransition(
                                              type: PageTransitionType
                                                  .fade,
                                              child: EditCategory(catname: selectedname, catdisc:selecteddescription,allparent: purchase, catid: selectedparid,)));
                                    },
                                  ),
                                  RaisedButton(
                            elevation: 10,
                            ...
                            shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10)),
                            child: Text('Delete Category',style: GoogleFonts.poppins(fontSize: 16, color: Colors.white),),
                            onPressed: (){
                ...
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "category",),
                ),
              if(showalert==false)
                Positioned(
                  top: 100,
                        ...
                        onPressed:(){
                          ...
                          Navigator
                              ...
                              PageTransition(
                                  type: PageTransitionType
                                      .fade,
                                  child: AddCategory(allparent: purchase,)));
                        },
