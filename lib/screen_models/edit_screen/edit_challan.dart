...
class EditDelivChallan extends StatefulWidget {
  EditDelivChallan({required this.id});

  final String id;
  @override
  _EditDelivChallanState createState() => _EditDelivChallanState();
}

class _EditDelivChallanState extends State<EditDelivChallan> {
  //-------for user type-----//
  ...
  void generate_Bill() async {
    ...
    try {
      ...
      var rsp =
          await gbill("/member/process", "delivery_challan.php", formData);
      //debugPrint(rsp.toString());
      if (rsp.containsKey('status')) {
        setState(() {
        ...
        if (rsp['status'].toString() == "true") {
          showPrintedMessage(context, "Success", "Challan Updated Successfully",
  ...
  //get states api
  void getChallanDet() async {
    setState(() {
      showpartyfields = false;
    });
    try {
      var rsp = await apiurl("/member/process", "delivery_challan.php",
          {"type": "view_json", "challan_no": widget.id.toString()});
      //debugPrint('bill returned - '+rsp.toString());
      //debugPrint('avbb - '+rsp['data'][0]['prods'].length.toString());
      if (rsp.containsKey('status')) {
        setState(() {
          showloader = false;
        ...
        if (rsp['status'].toString() == "true") {
          setState(() {
            ...
            totalselected_rate.clear();
            total_elementwise_exclu_rate.clear();
            prods = rsp['data'][0]['prods'];
            //debugPrint(prods.toString());
            totalselected_id.clear();
            partyname = 1100;
            formateddate = rsp['data'][0]['challan_date'].toString();
            selected_cloud_contact_id = rsp['data'][0]['bill_to'].toString();
            total_remarks_Controller.text =
                rsp['data'][0]['remarks'].toString();
            duration_Controller.text = rsp['data'][0]['remarks'].toString();
            pnameController.text = rsp['data'][0]['bt_name'].toString();
            eway_Controller.text = rsp['data'][0]['eway'].toString();
            for (var i = 0; i < rsp['data'][0]['prods'].length; i++) {
              totalselected_id
                  .add(rsp['data'][0]['prods'][i]['product_id'].toString());
              discountflat.add(rsp['data'][0]['prods'][i]['disc'].toString());
              description
                  .add(rsp['data'][0]['prods'][i]['prod_desc'].toString());
              discountperct.add('0');
              totalselected_name
                  .add(rsp['data'][0]['prods'][i]['prod_name'].toString());
              totalselected_val
                  .add(rsp['data'][0]['prods'][i]['qsuom'].toString());
              total_base_rate.add(rsp['data'][0]['prods'][i]['sp'].toString());
              intrim_prod_base_rate
                  .add(rsp['data'][0]['prods'][i]['sp'].toString());
              prod_rate_with_discount
                  .add(rsp['data'][0]['prods'][i]['sp'].toString());
              totalselected_rate
                  .add(rsp['data'][0]['prods'][i]['sp'].toString());
              totalselected_uom
                  .add(rsp['data'][0]['prods'][i]['standard'].toString());
              total_elementwise_exclu_rate.add(
                  ((double.parse(rsp['data'][0]['prods'][i]['sp'].toString()) *
                          double.parse(
                              rsp['data'][0]['prods'][i]['qsuom'].toString())))
                      .toStringAsFixed(2));
              var a =
                  allproids.indexOf(rsp['data'][0]['prods'][i]['product_id']);
              totalselected_tax
                  .add(rsp['data'][0]['prods'][i]['gst_value'].toString());
              total_elementwise_exclu_tax_val.add(((double.parse(
                          rsp['data'][0]['prods'][i]['gst_value'].toString()) /
                      100) *
                  (double.parse(rsp['data'][0]['prods'][i]['sp'].toString()) *
                      double.parse(
                          rsp['data'][0]['prods'][i]['qsuom'].toString()))));
              //debugPrint('index - '+a.toString());
              products[allproids
                      .indexOf(rsp['data'][0]['prods'][i]['product_id'])]
                  ['value'] = rsp['data'][0]['prods'][i]['qsuom'].toString();
              products[allproids.indexOf(
                      rsp['data'][0]['prods'][i]['product_id'])]['controller']
                  .text = rsp['data'][0]['prods'][i]['qsuom'].toString();
              setval_rate();
            }
          });
        } else if (rsp['status'].toString() == "false") {
  ...
  void initState() {
    ...
    setState(() {
      billno = widget.id.toString();
      start_serial_Controller.text = widget.id.toString();
    });
    getproduct();
    get_status();
    getWarehouse();
  ...
  AddAmount(String pid, BuildContext context, String Product, int index,
      String amount, String from) {
    setState(() {
      ...
      if (rsp.containsKey('status')) {
        ...
        if (rsp['status'].toString() == "true") {
          setState(() {
            ...
            for (var i = 0; i < products.length; i++) {
              allproids.add(products[i]['iid'].toString());
            }
      ...
      setState(() {
        ...
        for (var i = 0; i < itemsprod.length; i++) {
          final index = dummySearchList.indexWhere(
              (element) => element['hsn_code'] == itemsprod[i]['hsn_code']);
            ...
            child: isadditem_clicked == false
                ? Scaffold(
                    ...
                    appBar: AppBar(
                      ...
                      title: Text(
                        'Edit Delivery Challan no :' + widget.id.toString(),
                    ...
                    bottomNavigationBar: totalselected_id.isNotEmpty
                        ? Container(
                            ...
                            child: RaisedButton(
                                ...
                                color: AppBarColor,
                                onPressed: () {
                                  if (selected_cloud_contact_id.toString() !=
                                      '') {
                                    generate_Bill();
                                  } else {
                                    showPrintedMessage(
                                          ...
                                          children: [
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: RaisedButton(
                                                                                ...
                                                                                child: Text('Save Date', style: TextStyle(fontSize: 16, color: Colors.white)),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                          SizedBox(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      AnimatedContainer(
                                                                        ...
                                                                        width: MediaQuery.of(context)
                                                                            .size
                                                                            .width,
                                                                        child: selectednumber.isNotEmpty
                                                                            ? ListView.builder(
                                                                                                        ...
                                                                                                        child: Column(
                                                                                                          ...
                                                                                                          children: [
                                                                                                            ...
                                                                                                            if (selectednumber.isNotEmpty)
                                                                                                              Text(
                                                                                                                selectednumber[indexk].toString().replaceAll(' ', '').toString().trim(),
                                            ...
                                            if (index ==
                                              ...
                                              Padding(
                                                ...
                                                child: Divider(
                                                  color:
                                                      AppBarColor.withOpacity(
                                                          0.3),
                                                  thickness: 0.2,
                                                ),
                                              ),
                                            if (index ==
                                                    totalselected_id.length -
                                                        1 &&
                                                isregistered == false)
                                              Row(
                                                mainAxisAlignment:
                                                            ...
                                                            Switch(
                                                              onChanged: (v) {
                                                                setState(() {
                                                                  ...
                                                                  if (v ==
                                                                      true) {
                                                                    total_exclusive_val = double.parse(
                                                                            total_exclusive_val.toString())
                                                                        .round()
                                                                        .toString();
                                                                    total_amount_after_additional = double.parse(
                                                                            total_amount_after_additional.toString())
                                                                        .round()
                                                                        .toString();
                                                                  } else {
                                                                    total_amount_after_additional =
                                                                        un_round_items_total
                                                                            .toString();
                                                                    total_exclusive_val =
                                                                        un_round_items_subtotal
                                                                            .toString();
                                                                  }
                                                                });
                                                              },
                                    ...
                                    children: [
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          setState(
                                                                            ...
                                                                            Navigator.pop(context);
                                                                            billno =
                                                                                start_serial_Controller.text.toString();
                                                                          });
                                                                        },
                                                                        child: Text(
                                                                            'Save Date',
                                      ...
                                      if (showfirstloader == false)
                                        GestureDetector(
                                          ...
                                          child: AnimatedContainer(
                                            // height: totalselected_id.isNotEmpty?1100:searchheight!=0?1100+searchheight:partyname,
                                            duration:
                                                                                              ...
                                                                                              Container(
                                                                                                  ...
                                                                                                  child: Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      if (selectednumber.isNotEmpty)
                                                                                                        Text(
                                                                                                          selectednumber[index].toString().replaceAll(' ', '').toString().trim(),
                                                                                                          style: TextStyle(fontSize: 12, color: Colors.grey),
                                                                                                        ),
                                                                                                    ],
                                                                                                  )),
                                ...
                                ? IconButton(
                                    onPressed: () {
                                      setState(() {
                                        ...
                                        total_base_rate.clear();
                                        intrim_prod_base_rate.clear();
                                        discount_percent_Controller.text =
                                            '0.0';
                                        getproduct();
                                      });
                                    },
