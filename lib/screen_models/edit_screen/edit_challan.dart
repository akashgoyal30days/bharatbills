  ...
  void generate_Bill() async{
    ...
    try{
      ...
      if(rsp.containsKey('status')){
        ...
        if(rsp['status'].toString()=="true"){
          showPrintedMessage(context, "Success", "Challan Updated Successfully", Colors.white,Colors.green, Icons.info, true, "top");
      ...
      if(rsp.containsKey('status')){
        ...
        if(rsp['status'].toString()=="true"){
          setState(() {
            ...
            total_remarks_Controller.text = rsp['data'][0]['remarks'].toString();
            ...
            for(var i=0; i<rsp['data'][0]['prods'].length; i++){
              totalselected_id.add(rsp['data'][0]['prods'][i]['product_id'].toString());
              discountflat.add(rsp['data'][0]['prods'][i]['disc'].toString());
              description.add(rsp['data'][0]['prods'][i]['prod_desc'].toString());
              discountperct.add('0');
              totalselected_name.add(rsp['data'][0]['prods'][i]['prod_name'].toString());
              totalselected_val.add(rsp['data'][0]['prods'][i]['qsuom'].toString());
              total_base_rate.add(rsp['data'][0]['prods'][i]['sp'].toString());
              intrim_prod_base_rate.add(rsp['data'][0]['prods'][i]['sp'].toString());
              prod_rate_with_discount.add(rsp['data'][0]['prods'][i]['sp'].toString());
              totalselected_rate.add(rsp['data'][0]['prods'][i]['sp'].toString());
              totalselected_uom.add(rsp['data'][0]['prods'][i]['standard'].toString());
              total_elementwise_exclu_rate.add(
                  ((double.parse(rsp['data'][0]['prods'][i]['sp'].toString()) *
                      double.parse(rsp['data'][0]['prods'][i]['qsuom'].toString()))).toStringAsFixed(2));
              var a = allproids.indexOf(rsp['data'][0]['prods'][i]['product_id']);
              totalselected_tax.add(rsp['data'][0]['prods'][i]['gst_value'].toString());
              total_elementwise_exclu_tax_val.add(
                  ((double.parse(rsp['data'][0]['prods'][i]['gst_value'].toString()) / 100) *
                      (double.parse(rsp['data'][0]['prods'][i]['sp'].toString()) *
                          double.parse(rsp['data'][0]['prods'][i]['qsuom'].toString()))));
              //debugPrint('index - '+a.toString());
              products[allproids.indexOf(rsp['data'][0]['prods'][i]['product_id'])]['value']=rsp['data'][0]['prods'][i]['qsuom'].toString();
              products[allproids.indexOf(rsp['data'][0]['prods'][i]['product_id'])]['controller'].text=rsp['data'][0]['prods'][i]['qsuom'].toString();
              setval_rate();
            }
          }
          );
    ...
    if(query.isNotEmpty) {
      ...
      setState(() {
        ...
        for(var i=0; i<itemsprod.length; i++){
          final index = dummySearchList.indexWhere((element) =>
          element['hsn_code'] == itemsprod[i]['hsn_code']);
    ...
    return showbill_loader==false?WillPopScope(
        ...
        child: isadditem_clicked==false?Scaffold(
            ...
            appBar: AppBar(
              ...
              title:Text('Edit Delivery Challan no :'+widget.id.toString(), style: GoogleFonts.poppins(fontSize: 16),),
            ),
                ...
                child: RaisedButton(
                    ...
                    onPressed:(){
                      if(selected_cloud_contact_id.toString()!='') {
                        ...
                        showPrintedMessage(context, "Alert", "Please select a party name", Colors.white,Colors.redAccent, Icons.info, true, "top");
                      }
                    },
                    child:Text('Update Challan', style:TextStyle(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    if(selectednumber.isNotEmpty)
                                                                                      Text(selectednumber[indexk].toString().replaceAll(' ', '').toString().trim(), style: TextStyle(fontSize: 12, color: Colors.grey),),
                                                                                  ],
                                                                                )),
                                                                            if(items.isNotEmpty)
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 10, bottom: 2, top: 8, right: 10),                                child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Container(
