...
class _EditCustomerState extends State<EditCustomer> {
  ...
  void fillwithgstapi() async {
    ...
    try {
      var rsp = await apiurl("/member/process", "common.php",
          {"type": "gst_dataa", "gst_num": fwgstnoController.text});
        ...
        if (rsp['status'].toString() == "true") {
          setState(() {
            ...
            addressController.text =
                rsp['data']['pradr']['addr']['bno'].toString() +
                    ' ' +
                    rsp['data']['pradr']['addr']['flno'].toString() +
                    ' ' +
                    rsp['data']['pradr']['addr']['st'].toString() +
                    ' ' +
                    rsp['data']['pradr']['addr']['city'].toString() +
                    ' ' +
                    rsp['data']['pradr']['addr']['loc'].toString() +
                    ' ' +
                    rsp['data']['pradr']['addr']['dst'].toString();
            pinController.text =
                rsp['data']['pradr']['addr']['pncd'].toString();
            cityController.text =
                rsp['data']['pradr']['addr']['city'].toString();
  ...
  void update() async {
    ...
    try {
      var rsp = await apiurl("/member/process",
          widget.fromscreen == "Customer" ? "customer.php" : "supplier.php", {
        "type": "updateApp",
        ...
        onWillPop: () async {
          if (widget.fromscreen == "Customer") {
            ...
            Navigator.pushReplacement(
                context,
                PageTransition(
                    type: PageTransitionType.fade, child: AllCustomerScreen()));
          } else {
            Navigator.of(context).popUntil((route) => route.isFirst);
            Navigator.pushReplacement(
                context,
                PageTransition(
                    type: PageTransitionType.fade, child: AllSupplierScreen()));
          }
          return false;
        },
        child: Scaffold(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            child: Text(
                                              'Providing Party GST number will automatically update'
                                              ' party details like Name, Address, State, Pin code etc.',
                                              style: GoogleFonts.poppins(
                                                  fontSize: 15,
                                                  fontWeight: FontWeight.w500,
                                                  color: Colors.black),
                                              ...
                                              shape: RoundedRectangleBorder(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          10)),
                                              onPressed:
                                                  fwgstnoController.text.isEmpty
                                                      ? null
                                                      : () {
                                                          fillwithgstapi();
                                                        },
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.fromLTRB(
                                          10, 0, 10, 0),
                                      child: TextFormField(
                                        readOnly: gststatus != 'Unregistered'
                                            ? false
                                            : true,
                                        decoration: new InputDecoration(
                                          isDense: true,
                                          labelText: gststatus != 'Unregistered'
                                              ? "GST No"
                                              : "GST No",
                                          hintText: gststatus != 'Unregistered'
                                              ? "GST No"
                                              : "GST No",
                                          labelStyle: GoogleFonts.poppins(
                                              fontSize: 14, color: AppBarColor),
