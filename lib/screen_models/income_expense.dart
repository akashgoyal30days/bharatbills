...
class _InExpScreenState extends State<InExpScreen> with SingleTickerProviderStateMixin {
            ...
            children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Income / Expenses', style: GoogleFonts.poppins(
              ...
              if(showalertdetail==false)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "incomeexp",),
                ),
            ],
          ),
...
class _ExpenseState extends State<Expense> {
  ...
  void filterSearchResults(String query) {
    ...
    if(query.isNotEmpty) {
      List dummyListData = [];
      dummySearchList.forEach((item) {
        if(item['vch_no'].toString().toLowerCase().contains(query.toLowerCase())) {
          setState(() {
            dummyListData.add(item);
            isbillfound = true;
          });
              ...
              Column(
                children: [
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == true)
                    Container(
                      height: showalertdetail==false&&purchase.isNotEmpty?MediaQuery.of(context).size.height-235:showalertdetail==false&&purchase.isEmpty?MediaQuery.of(context).size.height-235:440,
                      width: MediaQuery.of(context).size.width,
                      color: Colors.white,
                              ...
                              return GestureDetector(
                                onTap: (){
                                  ...
                                  setState(() {
                                    ...
                                    pdfPath = "";
                                    selectedbillno = "";
                                    selectedbillno = purchase[index]['vch_no'].toString();
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text("Vch No : ", style: GoogleFonts.poppins(
                                                        fontSize: 16, color: Colors.black, fontWeight: FontWeight.w500
                                                    ),),
                                                    Text(purchase[index]['vch_no'].toString(), style: GoogleFonts.poppins(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" ₹"+" "+purchase[index]['vch_amount'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                    Row(
                                                      children: [
                                                        Text('Vch Date :', style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w500
                                                        ),),
                                                        Text(" "+purchase[index]['vch_date'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w500
                                                        ),),
                                                      ],
                                                    ),
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Text('Narration :', style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                        Text(" "+purchase[index]['vch_narration'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                              ...
                              return GestureDetector(
                                onTap: (){
                                  ...
                                  setState(() {
                                    ...
                                    pdfPath = "";
                                    selectedbillno = "";
                                    selectedbillno = items[index]['vch_no'].toString();
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(items[index]['vch_no'].toString(), style: GoogleFonts.poppins(
                                                        fontSize: 16, color: Colors.black, fontWeight: FontWeight.w300
                                                    ),),
                                                  ],
                                                ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" ₹"+" "+items[index]['vch_amount'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['vch_date'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w500
                                                        ),),
                                                      ],
                                                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['vch_narration'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                  ...
                  if(showloader==false&&items.isEmpty&&isbillfound == false)
                    Container(
                      ...
                      color: Colors.white,
                      child: Center(
                        child: Text('No voucher found', style: GoogleFonts.poppins(
                            fontSize: 18, color: Colors.black
                        ),),
                      ),
                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+purchase[index]['supplier'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['supplier'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
