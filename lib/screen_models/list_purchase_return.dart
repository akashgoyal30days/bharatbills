...
class _ViewPReturnState extends State<ViewPReturn> {
  ...
  Future getdirectory(String from) async {
    ...
    if(isPermissionStatusGranted){
      final Directory _appDocDirFolder = Directory('${dir!.path}/$Appname/Purchase Return');
  ...
  void filterSearchResults(String query) {
    ...
    if(query.isNotEmpty) {
      ...
      dummySearchList.forEach((item) {
        if(item['bill_from_name'].toString().toLowerCase().contains(query.toLowerCase())||item['pr_no'].toString().toLowerCase().contains(query.toLowerCase())) {
          setState(() {
              ...
              children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10,),
                                Text('Purchase Return', style: GoogleFonts.poppins(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                labelText: "Search using Purchase Return No, name",
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Text(warelist[index]['bill_from_name'].toString(), style: GoogleFonts.poppins(
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanno = warelist[index]['pr_no'].toString();
                                                                ishtmlloaded = false;
                                                              });
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text('Purchase Return No. :', style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                          Text(" "+warelist[index]['pr_no'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text('Purchase Return Date :', style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(" "+warelist[index]['bill_from_address'].toString(), style: GoogleFonts.poppins(
                                                                fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                            ),),
                                                          ),
                                                        ],
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                              width:100,
                                                              child: Text(" "+warelist[index]['bill_from_contact'].toString(), style: GoogleFonts.poppins(
                                                                  fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                              ),),
                                                            ),
                                                          ],
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanid = warelist[index]['pr_id'].toString();
                                                              });
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanno = items[index]['pr_no'].toString();
                                                                ishtmlloaded = false;
                                                              });
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(" "+items[index]['pr_no'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            width:MediaQuery.of(context).size.width-120,
                                                            child: Text(" "+items[index]['bill_from_address'].toString(), style: GoogleFonts.poppins(
                                                                fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                            ),),
                                                          ),
                                                        ],
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                              width:100,
                                                              child: Text(" "+items[index]['bill_from_contact'].toString(), style: GoogleFonts.poppins(
                                                                  fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                              ),),
                                                            ),
                                                          ],
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              ...
                                                              setState(() {
                                                                selectedchallanid = items[index]['pr_id'].toString();
                                                              });
                                                              showAlertDialog(context);
                                                            },
                                                            child:Text('Delete', style:TextStyle(color:Colors.red))
                ...
                if(showalertdetail==false)
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: BottomBar(lastscreen: "preturn",),
                  ),
                if(showalertdetail==false)
                  Positioned(
                    top: 100,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.circle, color: Colors.white,size: 15,),
                                    SizedBox(width: 10,),
                                    Text('PR No. :'+ selectedchallanno, style: GoogleFonts.poppins(
                                        fontSize: 15, color: Colors.white
                                    ),),
                                  ],
                                ),
