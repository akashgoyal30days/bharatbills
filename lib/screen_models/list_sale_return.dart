...
class ViewSReturn extends StatefulWidget {
  @override
  _ViewSReturnState createState() => _ViewSReturnState();
}

class _ViewSReturnState extends State<ViewSReturn> {
  ...
  Future getdirectory(String from) async {
    ...
    if(isPermissionStatusGranted){
      final Directory _appDocDirFolder = Directory('${dir!.path}/$Appname/Sale Return');
      if(await _appDocDirFolder.exists()){
        //debugPrint('in function 1');
        //debugPrint('exists');
        appDocDir = await _getDownloadDirectory();
        final String dirPath = '${appDocDir!.path}/$Appname/Sale Return';
  ...
  Future<void> shareFile(String number) async {
    ...
    if(filepaths!=null && filepaths != '') {
      await WhatsappShare.shareFile(
        text: 'Please find the Credit Note here',
        phone: "2345678900",
        filePath: [filepaths],
      );
      //OpenFile.open(filepaths);
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Delete"),
      content: Text("Do you want to delete this Credit Note?"),
      actions: [
        okButton,
        cancelButton
      ],
  ...
  void filterSearchResults(String query) {
    ...
    if(query.isNotEmpty) {
      ...
      dummySearchList.forEach((item) {
        if(item['bill_to_name'].toString().toLowerCase().contains(query.toLowerCase())||item['sr_no'].toString().toLowerCase().contains(query.toLowerCase())) {
          setState(() {
              ...
              children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10,),
                                Text('Sale Return', style: GoogleFonts.poppins(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                labelText: "Search using Credit Note No, name",
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanno = warelist[index]['sr_no'].toString();
                                                                ishtmlloaded = false;
                                                              });

                                                              viewchallan();
                                                            },
                                                            child:Text('View Credit Note', style:TextStyle(color:Colors.blue))
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text('Credit Note No. :', style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                          Text(" "+warelist[index]['sr_no'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text('Credit Note Date :', style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                          Text(" "+warelist[index]['sr_date'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanid = warelist[index]['sr_id'].toString();
                                                              });
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              setState(() {
                                                                selectedchallanno = items[index]['sr_no'].toString();
                                                                ishtmlloaded = false;
                                                              });
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(" "+items[index]['sr_no'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(" "+items[index]['sr_date'].toString(), style: GoogleFonts.poppins(
                                                              fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                          ),),
                                                        ],
                                                      ),
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed:(){
                                                              ...
                                                              setState(() {
                                                                selectedchallanid = items[index]['sr_id'].toString();
                                                              });
                                                              showAlertDialog(context);
                                                            },
                                                            child:Text('Delete', style:TextStyle(color:Colors.red))
                ...
                if(showalertdetail==false)
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: BottomBar(lastscreen: "sreturn",),
                  ),
                if(showalertdetail==false)
                  Positioned(
                    top: 100,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.circle, color: Colors.white,size: 15,),
                                    SizedBox(width: 10,),
                                    Text('Credit Note No. :'+ selectedchallanno, style: GoogleFonts.poppins(
                                        fontSize: 15, color: Colors.white
                                    ),),
                                  ],
                                ),
