  ...
  void save_Bill() async{
    ...
    try{
      ...
      formData = FormData.fromMap({
        ...
        "_req_token": token,
        "type":"addSnote",
        "pr_date":selecteddate.toString(),
        "bill_date": billdate.toString(),
        "bill_to":billto.toString(),
        "series": "manual",
        "pr_no":cnotenumberController.text.toString(),
      ...
      //debugPrint(rate_on.toString());
      //debugPrint(formData.fields.toString());
      var rsp = await gbill("/member/process", "preturn.php", formData);
      //debugPrint(rsp.toString());
      if(rsp.containsKey('status')){
        setState(() {
          showloader=false;
      ...
      if(rsp.containsKey('status')){
        ...
        if(rsp['status'].toString()=="true"){
          setState(() {
            ...
            billdate = rsp['BILL']['bill_date'].toString();
            billto = rsp['BILL']['bill_to'].toString();
            customername = rsp['BILL']['sup_name'].toString();
            for(var i =0 ; i<rsp['BILL']['prods'].length; i++){
              rsp['BILL']['prods'][i].addAll({'new_quant': TextEditingController()});
            }
            ...
            for(var i =0; i<allproducts.length; i++){
              ...
              if(allproducts[i]['rate_on'].toString() == 'uom1') {
                ...
                uom2.add(allproducts[i]['qsuom'].toString());
              }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              Column(
                children: [
                  ConstAppBar("purchase_return_help"),
                  Container(
                    height: 35,
                    width: MediaQuery.of(context).size.width,
                    color: AppBarColor,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Add Purchase Return', style: GoogleFonts.poppins(
                  ...
                  Container(
                      height: gotresp == false?MediaQuery.of(context).size.height-140:MediaQuery.of(context).size.height-240,
                      width:MediaQuery.of(context).size.width,
                      color: Colors.white,
                        ...
                        child: Container(
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  Text('Please select your bill to generate purchase return', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.blue,),textAlign: TextAlign.center,),
                                  SizedBox(height:20),
                                  Container(
                                    height: 45,
                                    width: MediaQuery.of(context).size.width,
                                      ...
                                      child: Padding(
                                        ...
                                        child: DropdownSearch<String>(
                                          ...
                                          onChanged: (s){
                                            ...
                                            setState(() {
                                              selectedbillid = custlistid[index].toString();
                                              //debugPrint(selectedbillid.toString());
                                            });
                                          },),
                                      ),
                                  ...
                                  Container(
                                    ...
                                    child: RaisedButton(
                                        ...
                                        color: Colors.green,
                                        onPressed:(){
                                          if(selectedbillid==null||selectedbillid==''){
                                            showPrintedMessage(context, "Error", "Please select a bill ", Colors.white,Colors.redAccent, Icons.info, true, "top");
                                          }else{
                                            gotresp = false;
                                            getBill();
                                          }
                                        ...
                                        child: Text('Get Bill Details', style: GoogleFonts.poppins(
                                            fontSize: 15, color: Colors.white
                                        ))
                                    ),
                                  )
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color: seriesid=="auto"?Colors.grey.withOpacity(0.3):Colors.white,
                                          ...
                                          child:  Center(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                readOnly: seriesid=="auto"?true:false,
                                                decoration: new InputDecoration(
                                                  floatingLabelBehavior: FloatingLabelBehavior.never,
                                                  contentPadding: EdgeInsets.symmetric(horizontal: 10),
                                                  isDense: true,
                                                  hintText: seriesid=="auto"?"Purchase note number":"Purchase note number *",
                                                ...
                                                controller: cnotenumberController,
                                              ),
                                            ),
                                          ),
                                        ),
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text(billdate.toString().replaceRange(9, billdate.length-1, ''), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                          ),
                                        ),
                                        SizedBox(width: 10,),
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: selecteddate==''||selecteddate==null?Text('Purchase note date *', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400),):Text(selecteddate.toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400),),
                                            ),
                                          ),
                                        ),
                                      ],
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Center(child: Text(customername.toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),)),
                                          ),
                                        ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Container(
                                              child: Text(allproducts[index]['prod_name'].toString(), style: TextStyle(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text('HSN', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.fromLTRB(0,8,8,8),
                                                      child: Text('GST %', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.fromLTRB(0,8,8,8),
                                                      child: Text('Rate', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text(allproducts[index]['hsn'].toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text(allproducts[index]['gst_value'].toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text(double.parse(allproducts[index]['sp'].toString()).toStringAsFixed(2), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                ],
                                              ),
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.fromLTRB(0,8,8,8),
                                                      child: Text('Old Quantity', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding: const EdgeInsets.fromLTRB(0,8,8,8),
                                                      child: Text('Return Quantity', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                    ),
                                                  ),
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  if(allproducts[index]['rate_on'].toString()=='uom1')
                                                    Container(
                                                      width: MediaQuery.of(context).size.width/2.5,
                                                      decoration: BoxDecoration(
                                                          border: Border.all(color: Colors.transparent,),
                                                      ...
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(8.0),
                                                        child: Text(allproducts[index]['qsuom'].toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                      ),
                                                    )else
                                                    Container(
                                                      width: MediaQuery.of(context).size.width/2.5,
                                                      ...
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(8.0),
                                                        child: Text(allproducts[index]['qauom'].toString(), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                                                      ),
                                                    ),
                                                  SizedBox(width: 10,),
                                                  Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            onChanged: (v){
                                                              if(v.isNotEmpty){
                                                                if(allproducts[index]['rate_on'].toString()=='uom1'){
                                                                  if(double.parse(v.toString())>double.parse(allproducts[index]['qsuom'])){
                                                                  ...
                                                                  if(double.parse(v.toString())>double.parse(allproducts[index]['qauom'])){
                                                                    showPrintedMessage(context, "Error", "Quantity should not exceed original quantity", Colors.white,Colors.redAccent, Icons.info, true, "top");
                                                                    setState(() {
                                                                      allproducts[index]['new_quant'].clear();
                                                                      allnewquant[index] = '0';
                                                            ...
                                                            decoration: new InputDecoration(
                                                              floatingLabelBehavior: FloatingLabelBehavior.never,
                                                              contentPadding: EdgeInsets.symmetric(horizontal: 10),
                                                              isDense: true,labelText: "New Quantity",
                                                              labelStyle: GoogleFonts.poppins(
                                                                  fontSize: 14, color: AppBarColor
                                                              ),
                                                              fillColor: Colors.white.withOpacity(0.5),
                                                            ...
                                                            controller: allproducts[index]['new_quant'],
                                                          ),
                                                        ),
                                                      )
                                                  ),
        ...
        bottomNavigationBar: gotresp == false?Container(
            height:0
        ):Container(
          height: 100,
          width: MediaQuery.of(context).size.width,
              ...
              children: [
                ...
                Container(
                  ...
                  child: RaisedButton(
                      ...
                      onPressed:(){
                        if(seriesid=="manual"){
                          if(cnotenumberController.text.isNotEmpty &&selecteddate!=''&&selecteddate!=null){
                            save_Bill();
                          }else{
