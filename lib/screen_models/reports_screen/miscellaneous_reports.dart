...
class _MiscReposState extends State<MiscRepos> {
  ...
  void getBill () async{
    ...
    try{
      var rsp = await webapiurl("/member/appview", widget.lastscreen=="Profit & Loss"?"pla.php":widget.lastscreen=="Day Book"?"daybookreport.php":"fundview.php", {
        //"type": "basic_sale",
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        color: Colors.white,
                        child: Row(
                          mainAxisAlignment: widget.lastscreen == 'Funds Flow'?MainAxisAlignment.spaceBetween:MainAxisAlignment.end,
                          children: [
                            if(widget.lastscreen == 'Funds Flow')
                            Container(
                              height: 45,
