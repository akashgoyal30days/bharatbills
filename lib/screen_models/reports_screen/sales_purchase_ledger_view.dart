...
class _BasicSalesState extends State<BasicSales> {
  ...
  ScrollController _mycontroller3 =
      new ScrollController(); // for each scrollables
  ScrollController _mycontroller4 =
      new ScrollController(); // for each scrollables
  ScrollController _mycontroller5 =
      new ScrollController(); // for each scrollables
  ...
  void getCustomer_supplier() async {
    if (widget.lastscreen == "Customer Ledger" ||
        widget.lastscreen == "Supplier Ledger") {
      setState(() {
        selectedcomp = "";
        custlist.clear();
        custlistid.clear();
    ...
    try {
      var rsp = widget.lastscreen != 'Opening Stock' &&
              widget.lastscreen != 'Closing Stock'
          ? await apiurl(
              "/member/process",
              widget.lastscreen == "Basic Sales" ||
                      widget.lastscreen == "Sales Return" ||
                      widget.lastscreen == "Credit Note" ||
                      widget.lastscreen == "Debit Note" ||
                      widget.lastscreen == "Customer Ledger"
                  ? "customer.php"
                  : "supplier.php",
              {
                  "type": "view_all",
          ...
          widget.lastscreen == "Basic Sales"
              ...
              : widget.lastscreen == "Sales Return"
                  ...
                  : widget.lastscreen == "Credit Note"
                      ...
                      : widget.lastscreen == "Credit Note"
                          ? "snotesview.php"
                          : widget.lastscreen == "Basic Purchase"
                              ? "purchaseview.php"
                              : widget.lastscreen == "Purchase Return"
                                  ? "prview.php"
                                  : widget.lastscreen == "Debit Note"
                                      ? "snotesview.php"
                                      : widget.lastscreen ==
                                              ...
                                              : widget.lastscreen ==
                                                  ...
                                                  : widget.lastscreen ==
                                                      ...
                                                      : widget.lastscreen ==
                                                          ...
                                                          : "",
          {
            if (widget.lastscreen == "Credit Note" ||
                widget.lastscreen == "Purchase Debit Note")
              "type": "c",
            if (widget.lastscreen == "Debit Note" ||
                widget.lastscreen == "Purchase Credit Note")
              "type": "d",
            if (widget.lastscreen == "Opening Stock") "type": "opening",
            if (widget.lastscreen == "Closing Stock") "type": "closing",
            'f_date': selectedfromdate.toString(),
            if (widget.lastscreen != "Opening Stock" &&
                widget.lastscreen != "Closing Stock")
              't_date': selectedtodate.toString(),
            if (widget.lastscreen == "Basic Sales" ||
                widget.lastscreen == "Sales Return" ||
                widget.lastscreen == "Credit Note" ||
                widget.lastscreen == "Debit Note")
              "customer": selectedcomp,
            if (widget.lastscreen == "Basic Purchase" ||
                widget.lastscreen == "Purchase Return" ||
                widget.lastscreen == "Purchase Credit Note" ||
                widget.lastscreen == "Purchase Debit Note")
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownSearch<String>(
                                    ...
                                    items: custlist,
                                    label: widget.lastscreen == "Basic Sales" ||
                                            widget.lastscreen ==
                                                "Sales Return" ||
                                            widget.lastscreen ==
                                                "Credit Note" ||
                                        ...
                                        : "Select Suppliers *",
                                    hint: "",
                                    selectedItem: widget.lastscreen !=
                                                "Customer Ledger" &&
                                            widget.lastscreen !=
                                                "Supplier Ledger"
                                        ? 'ALL'
