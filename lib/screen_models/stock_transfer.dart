  ...
  Future getdirectory(String from) async {
    ...
    if (isPermissionStatusGranted) {
      final Directory _appDocDirFolder =
          Directory('${dir!.path}/$Appname/Stock Transfer');
      ...
      setState(() {
        ...
        for (var i = 0; i < items.length; i++) {
          final index = dummySearchList.indexWhere(
              (element) => element['form_no'] == items[i]['form_no']);
                                                                    ...
                                                                    child: TextButton(
                                                                        onPressed: () {
                                                                          setState(
                                                                              () {
                                                                            selectedlistid =
                                                                                warelist[index]['sj_id'].toString();
                                                                            selectedformno =
                                                                                warelist[index]['form_no'].toString();
                                                                            ishtmlloaded =
                                                                                false;
                                                                          });
                                                                    ...
                                                                    child: TextButton(
                                                                        onPressed: () {
                                                                          setState(
                                                                              () {
                                                                            selectedlistid =
                                                                                items[index]['sj_id'].toString();
                                                                            selectedformno =
                                                                                items[index]['form_no'].toString();
