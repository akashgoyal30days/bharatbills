  ...
  void filterSearchResults(String query) {
    ...
    if(query.isNotEmpty) {
      ...
      dummySearchList.forEach((item) {
        if(item['name'].toString().toLowerCase().contains(query.toLowerCase())||item['location'].toString().toLowerCase().contains(query.toLowerCase())) {
          setState(() {
            ...
            children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Warehouse', style: GoogleFonts.poppins(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Text(warelist[index]['name'].toString(), style: GoogleFonts.poppins(
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Text('Trade Name :', style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                        Text(" "+warelist[index]['tradename'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+warelist[index]['address'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Text('Pin :', style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                        Text(" "+warelist[index]['loc_pin'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(" "+warelist[index]['location'].toString(), style: GoogleFonts.poppins(
                                                                fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                            ),),
                                                          ),
                                                        ],
                                                          ...
                                                          onPressed:(){
                                                            ...
                                                            Navigator
                                                                ...
                                                                PageTransition(
                                                                    type: PageTransitionType
                                                                        .fade,
                                                                    child: EditWareHouse(id:warelist[index]['wid'].toString())));
                                                          },
                                                          child:Text('Edit')
                                                      ),
                                                    )
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['tradename'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['address'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(" "+items[index]['loc_pin'].toString(), style: GoogleFonts.poppins(
                                                            fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                        ),),
                                                      ],
                                                    ),
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            width:MediaQuery.of(context).size.width-170,
                                                            child: Text(" "+items[index]['location'].toString(), style: GoogleFonts.poppins(
                                                                fontSize: 13, color: Colors.black, fontWeight: FontWeight.w400
                                                            ),),
                                                          ),
                                                        ],
                                                          ...
                                                          onPressed:(){
                                                            ...
                                                            Navigator
                                                                ...
                                                                PageTransition(
                                                                    type: PageTransitionType
                                                                        .fade,
                                                                    child: EditWareHouse(id:items[index]['wid'].toString())));
                                                          },
                                                          child:Text('Edit')
                                                      ),
                                                    )
              ...
              if(showalertdetail==false)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: BottomBar(lastscreen: "warehouse",),
                ),
              if(showalertdetail==false)
                Positioned(
                  top: 100,
